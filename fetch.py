#!/usr/bin/env python3
"""
Recuperation des codes promo YourSurprise depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/yoursurprise.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/yoursurprise.fr"
STORE_NAME = "YourSurprise"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour YourSurprise depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-yoursurprise)"
    }
    try:
